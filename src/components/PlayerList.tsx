          ...
          {game.players.map((player) => (
            ...
            >
              <div className="flex items-center">
                <BeanHead
                  className="rounded-full items-start flex-shrink-0 mr-3 h-12 w-12"
                  accessory={user.possibleAccessoryValues[player.character.accessory]}
                  body={user.possibleGenderValues[player.character.gender]}
                  circleColor="blue"
                  clothing={user.possibleClothingValues[player.character.clothing]}
                  clothingColor="red"
                  eyebrows={user.possibleEyebrowValues[player.character.eyebrow]}
                  eyes={user.possibleEyesValues[player.character.eyes]}
                  facialHair="none"
                  graphic="none"
                  hair={user.possibleHairValues[player.character.hair]}
                  ...
                  faceMask={false}
                  mouth={user.possibleMouthValues[player.character.mouth]}
                  skinTone={user.possibleSkintoneValues[player.character.skintone]}
                />
                <div>
                  <h4 className="text-sm font-semibold text-gray-900">
                    {player.character.name}

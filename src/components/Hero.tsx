        ...
        <div className="p-10">
          <div className="sm:mx-auto sm:w-full sm:max-w-md bg-white border-2 rounded-lg border-foreground">
            <div className="md:py-8 py-4 md:px-4 px-4 shadow sm:rounded-lg min-w-80">
              ...
              <div>
                <button className="group relative w-full flex justify-center gap-2 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#85c5e5] hover:bg-[#78b1ce] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Play Online
                </button>
              </div>
              {/* </form> */}
